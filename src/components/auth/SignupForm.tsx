  ...
  return (
    <Card className="w-full max-w-md mx-auto shadow-card bg-gradient-card">
      <CardHeader className="text-center">
        ...
        <CardTitle className="text-2xl font-bold text-foreground">Join RideShare</CardTitle>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div className="grid grid-cols-1 gap-4">
            <div className="space-y-2">
              ...
              />
              {errors.name && (
                <p className="text-sm text-ride-danger">{errors.name.message}</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              />
              {errors.phone && (
                <p className="text-sm text-ride-danger">{errors.phone.message}</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              {errors.confirmPassword && (
                <p className="text-sm text-ride-danger">{errors.confirmPassword.message}</p>
              )}
            </div>
          </div>
